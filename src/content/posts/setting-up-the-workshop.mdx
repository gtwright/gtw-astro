...
tags: ["Web Development", "AI in Practice", "Developer Experience"]
---

The [previous post](/posts/first-boot/) left a scaffolded project deployed and running. Before writing any components or content, I spent time on something that produces nothing visible: project documentation.
