...
description: "Notes from Snowflake's Boston event: what resonated and what I'm taking back."
published: 2026-03-17T12:00:00
draft: false
tags: ["Modern Data Stack", "AI in Practice", "Conferences"]
image: "/images/snowflake-dfb-2026-three-pillars.jpg"
---
...
Pillar 3 got the most energy in the room, the agents, the demos. But the message underneath was clear: Pillar 2 is where most organizations are weakest, mine included. We have a solid start on the data foundation and we're beginning to explore integration use cases, but the semantic layer is new territory for us. Without it, the agents are guessing at business logic. They're good at it, but the time spent figuring things out is time humans are waiting, and it's more compute.
