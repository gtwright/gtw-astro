export const AUTHOR = {
  ...
  worksFor: { name: 'Boston Symphony Orchestra', url: 'https://www.bso.org' },
  location: 'Boston, MA',
  alumniOf: [
  ...
  affiliations: [
    ...
    { name: 'Boston Symphony Orchestra', url: 'https://www.bso.org', role: 'Director of Content and Digital Services' },
